...
//	 */
//	public RMessageEvent(MMessageEvent modelelement, MConfigParameterElement config)
//	{
//		super(modelelement, null, null, config);
//		// Create initial pojo value.
//		try
//		{
//			@SuppressWarnings("unchecked")
//			T t = (T)modelelement.getType().getType(((MicroAgent)getAgent()).getClassLoader()).getConstructor().newInstance();
//			this.msg	= t;
//		}
//		catch(Exception e)
//		{
