...
//	protected List<IResultListener<Void>> listeners;
	 ...
	 */
	public RFinishableElement(/*MProcessableElement modelelement,*/ Object pojoelement, IComponent comp, List<Object> pojoparents/*, Map<String, Object> vals*/)
	{
		super(pojoelement, comp, pojoparents);
	}
