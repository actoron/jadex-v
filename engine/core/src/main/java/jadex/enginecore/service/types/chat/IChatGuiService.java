...
//	@Timeout(Timeout.NONE)
	 ...
	 */
	public IIntermediateFuture<IChatService> postMessage(String text, IComponentIdentifier[] receivers, boolean self);
	 ...
	 */
	public IIntermediateFuture<IChatService> postStatus(String status, byte[] image, IComponentIdentifier[] receivers);
