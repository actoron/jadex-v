...
import jadex.bding.tool.BDIViewer.IForceRefresh;
...
public class ReasoningPanel extends JPanel
{
        ...
        if(snapshot != null)
        {
            ...
            if(history != null)
            {
                    ...
                    i--)
                {
                    ...
                    /*
                     * Don't show an entry twice if it is
                     * still contained in currentReasoning.
                     */
                    if(currentEntries == null ||
    ...
    protected void addEntry(
        ...
        boolean current)
    {
        ReasoningEntryPanel panel =
            new ReasoningEntryPanel(
                entry,
                current);
    ...
    protected class ReasoningEntryPanel
        extends JPanel
        implements IForceRefresh
    {
        protected final ReasoningEntry entry;
        protected final boolean current;

        protected final JLabel durationLabel;

        public ReasoningEntryPanel(
            ReasoningEntry entry,
            boolean current)
        {
