...
public abstract class AbstractModelLoader
{
	 ...
	 */
	protected abstract ICacheableModel	doLoadModel(String name, Object pojo, String[] imports, ClassLoader classloader) throws Exception;
	//ResourceInfo info,, Object context) 
...
//		System.out.println("filename: "+name);
	...
	//			System.out.println("hit: "+name+" "+cached);
				...
				if(cached==null)
				{
					try
					{
						cached	= doLoadModel(name, pojo, imports, classloader);//, context);
					}
					catch(Exception e)
					{
