...
public abstract class AbstractModelLoader
{
	 ...
	 */
	protected abstract ICacheableModel	doLoadModel(String name, Object pojo, String[] imports, ClassLoader classloader,
	ResourceInfo info) throws Exception;//, Object context) 
...
//		System.out.println("Classloader set: "+this+" "+classloader);
	 ...
	 *  @param clkey	The class loader key to allow caching by e.g. RID.
	 */
	public synchronized ICacheableModel	loadModel(String name, Object pojo, String[] imports, Object clkey, 
		ClassLoader classloader, Object context) throws Exception
	{
		return loadModel(name, pojo, null, imports, clkey, classloader);
	}
	 ...
	 *  @param clkey	The class loader key to allow caching by e.g. RID.
	 */
	public synchronized ICacheableModel	loadModel(String name, Object pojo, String extension, String[] imports, Object clkey, ClassLoader classloader) throws Exception
	{
//		System.out.println("filename: "+name);
	...
	//			System.out.println("hit: "+name+" "+cached);
				...
				if(cached==null)
				{
					try
					{
						cached	= doLoadModel(name, pojo, imports, classloader, info);//, context);
					}
					catch(Exception e)
					{
