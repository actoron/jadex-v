...
//		thread.setWaitingState(ProcessThread.WAITING_FOR_TIME);
	 ...
	 */
	public abstract void doWait(MActivity activity, IComponent instance, ProcessThread thread, long duration);
	 ...
	 */
	public void cancel(final MActivity activity, IComponent instance, final ProcessThread thread)
	{
