...
public class GatewayORActivityHandler	extends AbstractGatewayActivityHandler	 implements IActivityHandler
{
	 ...
	 */
	protected Collection<ProcessThread>	performSplit(MActivity activity, IComponent instance, ProcessThread thread)
	{
...
//			System.out.println("Evaluated: "+ret);
		...
		{
			System.out.println("Error in branch condition: "+thread+", "+exp+", "+e);
