...
public abstract class AbstractTask implements ITask
{
	 ...
	 */
	public IFuture<Void> execute(ITaskContext context, IComponent instance)
	{
	 ...
	 */
	public abstract void doExecute(ITaskContext context, IComponent instance)	throws Exception;
