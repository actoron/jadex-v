...
//	public IFuture getServices(final String name);
	 ...
	 */
	public static IValueFetcher	getFetcher(String scope)
	{
		return getFetcher(scope, null);
	}
	 ...
	 */
	public static IValueFetcher	getFetcher(String scope, Map<String, Object> values)
	{
