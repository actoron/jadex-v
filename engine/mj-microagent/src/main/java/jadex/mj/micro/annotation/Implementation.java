package jadex.mj.micro.annotation;
...
public @interface Implementation
{
	...
	public static final String	PROXYTYPE_RAW	= "raw";//BasicServiceInvocationHandler.PROXYTYPE_RAW;
	
	/** The direct proxy type (supports custom interceptors, but uses caller thread). */
	public static final String	PROXYTYPE_DIRECT	= "direct"; //BasicServiceInvocationHandler.PROXYTYPE_DIRECT;
	
	/** The (default) decoupled proxy type (decouples from caller thread to component thread). */
	public static final String	PROXYTYPE_DECOUPLED	= "decoupled"; //BasicServiceInvocationHandler.PROXYTYPE_DECOUPLED;
