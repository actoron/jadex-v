	...
	public void	testGetLocalService()
	{
		...
		try
		{
			...
			IThrowingFunction<IComponent, IHelloService>	getservice
				= comp -> comp.getFeature(IRequired2Feature.class).getLocalService(IHelloService.class);
	...
	public void	testSearchService()
	{
		...
		try
		{
			...
			IThrowingFunction<IComponent, IHelloService>	search
				= comp -> comp.getFeature(IRequired2Feature.class).searchService(IHelloService.class).get(TIMEOUT);
	...
	public void	testGetLocalServices()
	{
		...
		try
		{
			...
			IThrowingFunction<IComponent, Collection<IHelloService>>	getservices
				= comp -> comp.getFeature(IRequired2Feature.class).getLocalServices(IHelloService.class);
	...
	public void	testSearchServices()
	{
		...
		try
		{
			...
			IThrowingFunction<IComponent, Collection<IHelloService>>	search
				= comp -> comp.getFeature(IRequired2Feature.class).searchServices(IHelloService.class).get(TIMEOUT);
		...
		try
		{
			...
			caller.scheduleStep(comp ->
			{
				...
				ISubscriptionIntermediateFuture<IHelloService>	query	=
					comp.getFeature(IRequired2Feature.class).addQuery(IHelloService.class);
				query.next(result ->
				{
					results.add(result);
				});
