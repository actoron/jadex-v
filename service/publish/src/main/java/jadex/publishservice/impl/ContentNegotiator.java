...
public class ContentNegotiator 
{
    ...
    public static Optional<String> negotiate(String rawAcceptHeader, Collection<String> mappingProduced, List<String> serverPreference) 
    {
        ...
        List<String> produced = (mappingProduced == null) ? Collections.emptyList(): mappingProduced.stream()
        ...
        else 
        {
            // 2. No declared produced types: follow client preference but use serverPreference as tiebreaker
        	 ...
        	 {
                 List<String> clientTypes = acceptList.stream().map(MediaTypeWithQ::getMediaType).collect(Collectors.toList());
