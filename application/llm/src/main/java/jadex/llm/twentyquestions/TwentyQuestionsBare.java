...
public class TwentyQuestionsBare implements ITwentyQuestionsBareService
{
	@Override
	...
	public static void main(String[] args)
	{
		...
		TwentyQuestionsBare tq = new TwentyQuestionsBare();
		app.create(tq).get();
		...
		String	prompt = """
				...
				## Game Play:
				1. Choose a famous person as your secret.
				2. Start a loop where you ask the player for a yes/no question about the secret person:
