...
public class EnvGui extends ApplicationAdapter 
{
    ...
    public void create() 
    {
        ...
        background = new Texture(Gdx.files.internal("jadex/bdi/cleanerworld/ui/images/background.png"));
        wastetex = new Texture(Gdx.files.internal("jadex/bdi/cleanerworld/ui/images/waste.png"));
        wastebintex = new Texture(Gdx.files.internal("jadex/bdi/cleanerworld/ui/images/wastebin.png"));
        wastebinfulltex = new Texture(Gdx.files.internal("jadex/bdi/cleanerworld/ui/images/wastebin_full.png"));
        stationtex = new Texture(Gdx.files.internal("jadex/bdi/cleanerworld/ui/images/chargingstation.png"));
        cleanertex = new Texture(Gdx.files.internal("jadex/bdi/cleanerworld/ui/images/cleaner.png"));
        backgroundtex = new Texture(Gdx.files.internal("jadex/bdi/cleanerworld/ui/images/background.png"));
        uptex = new Texture(Gdx.files.internal("jadex/bdi/cleanerworld/ui/images/up.png"));
        downtex = new Texture(Gdx.files.internal("jadex/bdi/cleanerworld/ui/images/down.png"));
        daytex = new Texture(Gdx.files.internal("jadex/bdi/cleanerworld/ui/images/day.png"));
        nighttex = new Texture(Gdx.files.internal("jadex/bdi/cleanerworld/ui/images/night.png"));
