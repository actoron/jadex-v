...
//			thread.setWaitingState(ProcessThread.WAITING_FOR_TASK);
			...
			try
			{
				...
				{
					tmp = new PojoTaskWrapper(tmp, instance, thread, activity.getComponentInjections(instance.getClass().getClassLoader()),
						activity.getArgumentInjections(instance.getClass().getClassLoader()), activity.getResultInjections(instance.getClass().getClassLoader()));
				}
