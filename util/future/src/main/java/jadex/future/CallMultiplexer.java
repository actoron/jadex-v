...
public class CallMultiplexer
{
	...
	{
		futuremap = new HashMap<Object, IFuture<?>>();
	}
	 ...
	 *  		on a "similar" call.
	 */
	public IFuture<?> doCall(IResultCommand<Object, Object> call)
	{
	 ...
	 *  		on a "similar" call.
	 */
	public IFuture<?> doCall(Object keyargs, IResultCommand<Object, Object> call)
	{
	 ...
	 *  		on a "similar" call.
	 */
	public IFuture<?> doCall(Object keyargs, IResultCommand<Object, Object> call, boolean commandaskey)
	{
