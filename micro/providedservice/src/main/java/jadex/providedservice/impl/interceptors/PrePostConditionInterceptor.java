package jadex.providedservice.impl.interceptors;
...
import jadex.providedservice.annotation.CheckIndex;
import jadex.providedservice.annotation.CheckNotNull;
import jadex.providedservice.annotation.CheckState;
import jadex.providedservice.impl.service.ServiceInvocationContext;
import jadex.providedservice.impl.service.interceptors.AbstractLRUApplicableInterceptor;
...
public class PrePostConditionInterceptor extends AbstractLRUApplicableInterceptor
{
	...
	public IFuture<Void> execute(final ServiceInvocationContext context)
	{
		...
		else
		{
			...
			{
				Future<?> fut = Future.getFuture(context.getMethod().getReturnType());
				fut.setException(ex);
