...
public class MicroAgentFeature	implements ILifecycle
{
	...
	{
		return IExecutionFeature.get().getComponent().getFeature(MicroAgentFeature.class);
	}
...
//					System.out.println("setVal: "+getComponent().getId()+" "+val+" "+field.getName());
	 ...
	 */
	public static IFuture<Void> invokeMethod(MicroAgent component, Class<? extends Annotation> ann, Object[] args)
	{
		IFuture<Void> ret;
